...
TEST_CASE("Testing stm32f10x Pin")
{
  ...
  stm32f10x::Gpio pin_b0('B', 0);    // B
  stm32f10x::Gpio pin_b7('B', 7);    // End of first half word
  stm32f10x::Gpio pin_c0('C', 0);    // C
  stm32f10x::Gpio pin_c8('C', 8);    // First of last half word
  stm32f10x::Gpio pin_d0('D', 0);    // D
  stm32f10x::Gpio pin_d12('D', 12);  // Middle of last half word
  stm32f10x::Gpio pin_e0('E', 0);    // E
  stm32f10x::Gpio pin_e15('E', 15);  // Last of last half word
